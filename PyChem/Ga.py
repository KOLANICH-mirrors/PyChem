...
class selParam(fpb.FoldPanelBar):
	...
	def _init_coll_gbsGaParams_Items(self, parent):
		...
		parent.Add(wx.Size(8, 8), (0, 2), border=10, flag=wx.EXPAND, span=(1, 1))
		...
		parent.Add(wx.Size(8, 8), (1, 2), border=10, flag=wx.EXPAND, span=(1, 1))
		...
		parent.Add(wx.Size(8, 8), (2, 2), border=10, flag=wx.EXPAND, span=(1, 1))
		...
		parent.Add(wx.Size(8, 8), (3, 2), border=10, flag=wx.EXPAND, span=(1, 1))
		...
		parent.Add(wx.Size(8, 8), (6, 2), border=10, flag=wx.EXPAND, span=(1, 1))
		...
		parent.Add(wx.Size(8, 8), (7, 2), border=10, flag=wx.EXPAND, span=(1, 1))
		...
		parent.Add(wx.Size(8, 8), (11, 2), border=10, flag=wx.EXPAND, span=(2, 3))
