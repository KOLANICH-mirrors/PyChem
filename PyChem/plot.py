...
class PolyEllipse(PolyPoints):
	...
	def draw(self, dc, printerScale, coord=None):
		...
		width = dim[0]
		height = dim[1]
		rect = scipy.zeros((len(self.scaled), 4), "f") + [0.0, 0.0, width, height]
...
class PlotCanvas(wx.Panel):
	...
	def SaveFile(self, fileName=""):
		...
		"""
		if _fileName[-3:].lower() not in ["bmp", "xbm", "xpm", "png", "jpg"]:
...
def _draw6Objects():
	...
	return PlotGraphics([line1, line1g, line1b, line2, line2g, line2b], "Bar Graph - (Turn on Grid, Legend)", "Months", "Number of Students")
