...
class TitleBar(bp.ButtonPanel):
	...
	def doOls(self, writeto, predy, predyv, predyt, labels, mask, rmsec, rmsecv, rmset):
		...
		# Write to textctrl
		write = []
		write.append(wx.lib.plot.PolyMarker((0, 12), marker="text", names="Root mean squared error"))
		write.append(wx.lib.plot.PolyMarker((0, 10), marker="text", names="Calibration"))
		write.append(wx.lib.plot.PolyMarker((19, 10), marker="text", names="Validation"))
		write.append(wx.lib.plot.PolyMarker((37, 10), marker="text", names="Test"))
		...
		write.append(wx.lib.plot.PolyMarker((0, 8), marker="text", names="% .2f" % rmsec))
		write.append(wx.lib.plot.PolyMarker((19, 8), marker="text", names="% .2f" % rmsecv))
		write.append(wx.lib.plot.PolyMarker((37, 8), marker="text", names="% .2f" % rmset))
		write.append(wx.lib.plot.PolyMarker((0, 6.5), marker="text", names="Least Squares Regression"))
		write.append(wx.lib.plot.PolyMarker((0, 4.5), marker="text", names="Coefficient"))
		write.append(wx.lib.plot.PolyMarker((19, 4.5), marker="text", names="Standard Error"))
		write.append(wx.lib.plot.PolyLine([[0, 3.5], [14, 3.5]]))
		write.append(wx.lib.plot.PolyLine([[19, 3.5], [38, 3.5]]))
		write.append(wx.lib.plot.PolyMarker((0, 3), marker="text", names="%.2f" % trnyi[0]))
		write.append(wx.lib.plot.PolyMarker((19, 3), marker="text", names="%.2f" % trnierr[0]))
		write.append(wx.lib.plot.PolyMarker((0, 2), marker="text", names="Train Intercept"))
		write.append(wx.lib.plot.PolyMarker((21, 2), marker="text", names="Train Slope"))
